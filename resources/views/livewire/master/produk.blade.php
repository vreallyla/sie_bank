<section>
                        ...
                        @if ($data->count())
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm whitespace-no-wrap">Rp. {{number_format($item->limit,2,',','.')}}</td>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-jet-label for="limit"  >
                    {{ __('Limit') }}<span class="text-base text-gray-400">*</span>
                </x-jet-label>
                <x-jet-input id="limit" class="block mt-1 w-full" type="text" placeholder="Isi Limit" wire:model.debounce.800ms="limit" />
    ...
    <x-jet-dialog-modal wire:model="modalConfirmDeleteVisible">
        ...
        <x-slot name="content">
            <span class="text-gray-400">Yakin hapus Produk?</span>
        </x-slot>

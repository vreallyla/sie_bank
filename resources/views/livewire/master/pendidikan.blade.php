<section>
    ...
    <div class="flex gap-14">
        {{-- head sisi kiri --}}
        <div class="w-4/6">
            <h1 class="text-3xl font-bold">Daftar Pendidikan</h1>
            <div class="breadcumb">
                <a href="{{ route('dashboard') }}">Dasboard</a>
                <span>Daftar Pendidikan</span>
            </div>
        </div>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        <x-slot name="title">
            {{ __(($dataId?'Ubah':'Buat') . ' Pendidikan') }}
        </x-slot>
    ...
    <x-jet-dialog-modal wire:model="modalConfirmDeleteVisible">
        ...
        <x-slot name="content">
            <span class="text-gray-400">Yakin hapus Pendidikan?</span>
        </x-slot>

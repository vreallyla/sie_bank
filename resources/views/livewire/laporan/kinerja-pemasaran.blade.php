<section>
    ...
    <div class="flex gap-14">
        {{-- head sisi kiri --}}
        <div class="w-4/6">
            <h1 class="text-3xl font-bold">Laporan Kinerja Pemasaran</h1>
            <div class="breadcumb">
                <a href="{{ route('dashboard') }}">Dasboard</a>
                <span>Laporan Kinerja Pemasaran</span>
            </div>
        </div>
              ...
              <div class="bg-gray-900 my-2 md:my-4 lg:my-6 px-6 py-3 rounded-md shadow">
                <div class="mb-4 pb-1 flex">
                    ...
                    >
                        ...
                        <span
                            class="rounded-r-md py-1 px-2 pl-0 bg-indigo-700 text-white font-thin text-xs items-center">
                            {{ $pickRelationId ? ucwords(App\Models\Wilayah::find($pickRelationId)->nama) . ',' : '' }}
                            {{!$this->pickRelationId?'Semua':"Per$opsRange"}} </span>
